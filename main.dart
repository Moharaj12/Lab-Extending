...
String _calculateAverageGrade() {
  ...
  double totalPoints = grades.fold(0.0, (sum, grade) {
    return sum + (gradeValues[grade.grade] ?? 0.0);
  });

  double averagePoints = totalPoints / grades.length;
  return averagePoints.toStringAsFixed(2); // Two decimal places
}
  ...
  Future<void> _exportGradesToCsv() async {
    ...
    final pathOfTheFileToWrite = "${directory.path}/grades_exported.csv";
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text("Grades exported successfully to $pathOfTheFileToWrite"))
      );
    } catch (e) {
      // User feedback for error
      ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text("Failed to export grades: $e"))
      );
    }
  }
  void _confirmExport() {
        ...
        return AlertDialog(
          ...
          actions: <Widget>[
            ...
            TextButton(
              ...
              onPressed: () {
                Navigator.of(context).pop(); // Close the dialog
                _exportGradesToCsv(); // Proceed with exporting
              },
            ),
          ],
        );
      ...
      appBar: AppBar(
        ...
        actions: <Widget>[
          ...
          IconButton(
            ...
            onPressed: _importCsv, // This will open the file picker when tapped
          ),
          IconButton(
